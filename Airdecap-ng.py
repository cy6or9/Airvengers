...
class Feedback:
	...
	#frame content 7
	Label(self.frame_content7, text = 'Airdecap-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
	...
	#End
        ...
        Label(self.frame_content, text = 'Airdecap-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
        ...
        #end
        self.C1 = Checkbutton(self.frame_content, text = "-l", fg="deepskyblue", \
        ...
        l1=Label(self.frame_content, text = ': don\'t remove the 802.11 header',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 2, column = 2, padx = 5, pady = 5)
        ...
        l2=Label(self.frame_content, text = ': access point MAC address filter',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 3, column = 2, padx = 5, pady = 5)
        
        self.C3 = Checkbutton(self.frame_content, text = "-k", fg="deepskyblue", \
        ...
        l3=Label(self.frame_content, text = ': WPA/WPA2 Pairwise Master Key in hex',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 4, column = 2, padx = 5, pady = 5)
        
        self.C4 = Checkbutton(self.frame_content, text = "-e", fg="deepskyblue", \
        ...
        l4=Label(self.frame_content, text = ': target network ascii identifier',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 5, column = 2, padx = 5, pady = 5)
        
        self.C5 = Checkbutton(self.frame_content, text = "-p", fg="deepskyblue", \
        ...
        l5=Label(self.frame_content, text = ': target network WPA/WPA2 passphrase',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 6, column = 2, padx = 5, pady = 5)
        ...
        l6=Label(self.frame_content, text = ': target network WEP key in hexadecimal',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 8, column = 2, padx = 5, pady = 5)

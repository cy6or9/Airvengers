...
class Feedback:
	...
	#frame content 7
	Label(self.frame_content7, text = 'Airdrop-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
	...
	#End
        ...
        Label(self.frame_content, text = 'Airdrop-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
        ...
        l1=Label(self.frame_content, text = ': Wireless card in monitor mode to inject from',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 2, column = 2, padx = 5, pady = 5)
        
        self.C2 = Checkbutton(self.frame_content, text = "-t", fg="deepskyblue", \
        ...
        l2=Label(self.frame_content, text = ': Airodump txt file in CSV format NOT the pcap',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 3, column = 2, padx = 5, pady = 5)
        
        self.C3 = Checkbutton(self.frame_content, text = "-p", fg="deepskyblue", \
        ...
        l3=Label(self.frame_content, text = ': Disable the use of Psyco JIT',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 4, column = 2, padx = 5, pady = 5)
        
        self.C4 = Checkbutton(self.frame_content, text = "-r", fg="deepskyblue", \
        ...
        l4=Label(self.frame_content, text = ': Rule File for matched deauths)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 5, column = 2, padx = 5, pady = 5)
        
        self.C5 = Checkbutton(self.frame_content, text = "-u", fg="deepskyblue", \
        ...
        l5=Label(self.frame_content, text = ': Updates OUI list.',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 6, column = 2, padx = 5, pady = 5)
        
        self.C6 = Checkbutton(self.frame_content, text = "-d", fg="deepskyblue", \
        ...
        l6=Label(self.frame_content, text = ': Injection driver. Default is mac80211.',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 8, column = 2, padx = 5, pady = 5)
        
        self.C7 = Checkbutton(self.frame_content, text = "-s", fg="deepskyblue", \
        ...
        l7=Label(self.frame_content, text = ': Time to sleep between sending each packet',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 9, column = 2, padx = 5, pady = 5)
        
        self.C8 = Checkbutton(self.frame_content, text = "-b", fg="deepskyblue", \
        ...
        l8=Label(self.frame_content, text = ': Turn on Rule Debugging',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 10, column = 2, padx = 5, pady = 5)
        
        self.C9 = Checkbutton(self.frame_content, text = "-l", fg="deepskyblue", \
        ...
        l9=Label(self.frame_content, text = ': Enable Logging to a file',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 11, column = 2, padx = 5, pady = 5)
        
        self.C10 = Checkbutton(self.frame_content, text = "-n", fg="deepskyblue", \
        ...
        l10=Label(self.frame_content, text = ': Time to sleep between loops',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 12, column = 2, padx = 5, pady = 5)

...
class Feedback:
	...
	#End
        ...
        Label(self.frame_content, text = 'Airtun-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
        ...
        #end
        self.C1 = Checkbutton(self.frame_content, text = "-x", fg="deepskyblue", \
        ...
        l1=Label(self.frame_content, text = ': maximum number of packets per second (optional)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 2, column = 2, padx = 5, pady = 5)
        
        self.C2 = Checkbutton(self.frame_content, text = "-a", fg="deepskyblue", \
        ...
        l2=Label(self.frame_content, text = ': set Access Point MAC address (mandatory)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 3, column = 2, padx = 5, pady = 5)
        
        self.C3 = Checkbutton(self.frame_content, text = "-i", fg="deepskyblue", \
        ...
        l3=Label(self.frame_content, text = ': capture packets from this interface (optional)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 4, column = 2, padx = 5, pady = 5)
        
        self.C4 = Checkbutton(self.frame_content, text = "-y", fg="deepskyblue", \
        ...
        l4=Label(self.frame_content, text = ': read PRGA from this file (optional / one of -y or -w must be defined)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 5, column = 2, padx = 5, pady = 5)
        
        self.C5 = Checkbutton(self.frame_content, text = "-W", fg="deepskyblue", \
        ...
        l5=Label(self.frame_content, text = ': use this WEP-KEY to encrypt packets (optional / one of -y or -w must be defined)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 6, column = 2, padx = 5, pady = 5)
        
        self.C6 = Checkbutton(self.frame_content, text = "-t", fg="deepskyblue", \
        ...
        l6=Label(self.frame_content, text = ': send frames to AP (1) or to client (0) (optional / defaults to 0)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 8, column = 2, padx = 5, pady = 5)
        
        self.C7 = Checkbutton(self.frame_content, text = "-r", fg="deepskyblue", \
        ...
        l7=Label(self.frame_content, text = ': read frames out of pcap file (optional)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 9, column = 2, padx = 5, pady = 5)
        
        self.C8 = Checkbutton(self.frame_content, text = "-h", fg="deepskyblue", \
        ...
        l8=Label(self.frame_content, text = ': source MAC address',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 10, column = 2, padx = 5, pady = 5)
        
        self.C9 = Checkbutton(self.frame_content, text = "-H", fg="deepskyblue", \
                 onvalue = "-H", offvalue = "", height=1, \
        ...
        l9=Label(self.frame_content, text = ': Display help. Long form help',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 11, column = 2, padx = 5, pady = 5)
        
        Label(self.frame_content, text = 'Repeater Options :',font=self.myfontnew, bg="midnightblue", fg="deepskyblue").grid(row = 12, column = 1)
        
        self.C10 = Checkbutton(self.frame_content, text = "--repeat", fg="deepskyblue", \
        ...
        l10=Label(self.frame_content, text = ': activates repeat mode. Short form -f.',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 13, column = 2, padx = 5, pady = 5)
        
        self.C11 = Checkbutton(self.frame_content, text = "--bssid", fg="deepskyblue", \
        ...
        l11=Label(self.frame_content, text = ': BSSID to repeat. Short form -d.',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 14, column = 2, padx = 5, pady = 5)
        
        self.C12 = Checkbutton(self.frame_content, text = "--netmask", fg="deepskyblue", \
                 onvalue = "--netmask", offvalue = "", height=1, \
                 width = 7, bg="midnightblue", font=self.customFont)
        ...
        l12=Label(self.frame_content, text = ': netmask for BSSID filter. Short form -m.',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 15, column = 2, padx = 5, pady = 5)
        #end

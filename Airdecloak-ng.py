...
class Feedback:
	...
	#frame content 7
	Label(self.frame_content7, text = 'Airdecloak-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
	...
	#End
        ...
        Label(self.frame_content, text = 'Airdecloak-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
        ...
        l1=Label(self.frame_content, text = ': Input capture file',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 2, column = 2, padx = 5, pady = 5)
        
        self.C2 = Checkbutton(self.frame_content, text = "--ssid", fg="deepskyblue", \
        ...
        l2=Label(self.frame_content, text = ': ESSID of the network to filter',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 3, column = 2, padx = 5, pady = 5)
        
        self.C3 = Checkbutton(self.frame_content, text = "--bssid", fg="deepskyblue", \
        ...
        l3=Label(self.frame_content, text = ': BSSID of the network to filter',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 4, column = 2, padx = 5, pady = 5)
        
        self.C4 = Checkbutton(self.frame_content, text = "--filters", fg="deepskyblue", \
        ...
        l4=Label(self.frame_content, text = ': Apply filters (separated by a comma)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 5, column = 2, padx = 5, pady = 5)
        
        self.C5 = Checkbutton(self.frame_content, text = "--null-packets", fg="deepskyblue", \
        ...
        l5=Label(self.frame_content, text = ': Assume that null packets can be cloaked.',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 6, column = 2, padx = 5, pady = 5)
        
        self.C6 = Checkbutton(self.frame_content, text = "--disable-base_filter", fg="deepskyblue", \
        ...
        l6=Label(self.frame_content, text = ': Do not apply base filter.',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 8, column = 2, padx = 5, pady = 5)
        
        self.C7 = Checkbutton(self.frame_content, text = "--drop-frag", fg="deepskyblue", \
        ...
        l7=Label(self.frame_content, text = ': Drop fragmented packets',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 9, column = 2, padx = 5, pady = 5)
        
        self.C8 = Checkbutton(self.frame_content, text = "--help", fg="deepskyblue", \
        ...
        l8=Label(self.frame_content, text = ': Displays this usage screen',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 10, column = 2, padx = 5, pady = 5)

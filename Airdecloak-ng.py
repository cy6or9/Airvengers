...
class Feedback:
	...
	#frame content 7
	Label(self.frame_content7, text = 'Airdecloak-ng',font=self.headerfont, bg="midnightblue", padx=10, pady=10).grid(row = 0, column = 0)
	...
	#End
        ...
        Label(self.frame_content, text = 'Airdecloak-ng',font=self.headerfont, bg="midnightblue", padx=10, pady=10).grid(row = 0, column = 0)
        ...
        l1=Label(self.frame_content, text = ': Input capture file',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 2, column = 2, padx = 5, pady = 5)
        ...
        l2=Label(self.frame_content, text = ': ESSID of the network to filter',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 3, column = 2, padx = 5, pady = 5)
        ...
        l3=Label(self.frame_content, text = ': BSSID of the network to filter',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 4, column = 2, padx = 5, pady = 5)
        ...
        l4=Label(self.frame_content, text = ': Apply filters (separated by a comma)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 5, column = 2, padx = 5, pady = 5)
        ...
        l5=Label(self.frame_content, text = ': Assume that null packets can be cloaked.',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 6, column = 2, padx = 5, pady = 5)
        ...
        l6=Label(self.frame_content, text = ': Do not apply base filter.',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 8, column = 2, padx = 5, pady = 5)
        ...
        l7=Label(self.frame_content, text = ': Drop fragmented packets',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 9, column = 2, padx = 5, pady = 5)
        ...
        l8=Label(self.frame_content, text = ': Displays this usage screen',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 10, column = 2, padx = 5, pady = 5)

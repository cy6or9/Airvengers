...
class Feedback:
	...
	self.fname=""
        ...
        # repeat for each tab
        self.frame_content2 = Frame(nb, name='frame_content2', bg="lightsteelblue")
        nb.add(self.frame_content2, text="Filter-2")
        self.frame_content3 = Frame(nb, name='frame_content3', bg="lightsteelblue")
        nb.add(self.frame_content3, text="Filter-3")
        self.frame_content4 = Frame(nb, name='frame_content4', bg="lightsteelblue")
        nb.add(self.frame_content4, text="Filter-4")
        self.frame_content6 = Frame(nb, name='frame_content6', bg="lightsteelblue")
	...
	self.frame_content7 = Frame(nb, name='frame_content7', bg="lightsteelblue")
        ...
        #End
	#frame content 7
	Label(self.frame_content7, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
	...
	#End        
        ...
        Label(self.frame_content, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
        ...
        l1=Label(self.frame_content, text = ': set Access Point MAC address',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 2, column = 2, padx = 5, pady = 5)
        
        self.C2 = Checkbutton(self.frame_content, text = "-i", fg="deepskyblue", \
        ...
        l2=Label(self.frame_content, text = ': capture packets from this interface',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 3, column = 2, padx = 5, pady = 5)
        
        self.C3 = Checkbutton(self.frame_content, text = "-w", fg="deepskyblue", \
        ...
        l3=Label(self.frame_content, text = ': use this WEP key to encrypt/decrypt packets',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 4, column = 2, padx = 5, pady = 5)
        
        self.C4 = Checkbutton(self.frame_content, text = "-h", fg="deepskyblue", \
        ...
        l4=Label(self.frame_content, text = ': source mac for MITM mode',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 5, column = 2, padx = 5, pady = 5)
        
        self.C5 = Checkbutton(self.frame_content, text = "-f", fg="deepskyblue", \
        ...
        l5=Label(self.frame_content, text = ': disallow specified client MACs (default: allow)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 6, column = 2, padx = 5, pady = 5)
        
        self.C6 = Checkbutton(self.frame_content, text = "-W", fg="deepskyblue", \
                 onvalue = "-W", offvalue = "", height=1, \
        ...
        l6=Label(self.frame_content, text = ': [don\'t] set WEP flag in beacons 0|1 (default: auto)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 7, column = 2, padx = 5, pady = 5)
        
        self.C7 = Checkbutton(self.frame_content, text = "-q", fg="deepskyblue", \
        ...
        l7=Label(self.frame_content, text = ': quiet (do not print statistics)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 8, column = 2, padx = 5, pady = 5)
        
        self.C8 = Checkbutton(self.frame_content2, text = "-v", fg="deepskyblue", \
        ...
        l8=Label(self.frame_content2, text = ':  verbose (print more messages) (long --verbose)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 9, column = 2, padx = 5, pady = 5)
        
        self.C9 = Checkbutton(self.frame_content2, text = "-M", fg="deepskyblue", \
        ...
        l9=Label(self.frame_content2, text = ': M-I-T-M between [specified] clients and bssids',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 10, column = 2, padx = 5, pady = 5)
        
        Label(self.frame_content2, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
        
        self.C10 = Checkbutton(self.frame_content2, text = "-A", fg="deepskyblue", \
                 onvalue = "-A", offvalue = "", height=1, \
        ...
        l10=Label(self.frame_content2, text = ': Ad-Hoc Mode (allows other clients to peer) (long --ad-hoc)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 11, column = 2, padx = 5, pady = 5)
        
        self.C11 = Checkbutton(self.frame_content2, text = "-Y", fg="deepskyblue", \
        ...
        l11=Label(self.frame_content2, text = ': external packet processing',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 12, column = 2, padx = 5, pady = 5)
        
        self.C12 = Checkbutton(self.frame_content2, text = "-c", fg="deepskyblue", \
        ...
        l12=Label(self.frame_content2, text = ': sets the channel the AP is running on',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 13, column = 2, padx = 5, pady = 5)
        
        self.C13 = Checkbutton(self.frame_content2, text = "-X", fg="deepskyblue", \
        ...
        l13=Label(self.frame_content2, text = ': hidden ESSID (long --hidden)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 14, column = 2, padx = 5, pady = 5)
        
        self.C14 = Checkbutton(self.frame_content2, text = "-s", fg="deepskyblue", \
        ...
        l14=Label(self.frame_content2, text = ': force shared key authentication',font=self.myfont, bg="midnightblue", fg="deepskyblue").grid(row = 15, column = 2, padx = 5, pady = 5)
        
        
        Label(self.frame_content3, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
        Label(self.frame_content3, text = 'Filter Options :',font=self.myfontnew, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 16, column = 1)
        
        self.C15 = Checkbutton(self.frame_content3, text = "-S", fg="deepskyblue", \
                 onvalue = "-S", offvalue = "", height=1, \
        ...
        l15=Label(self.frame_content3, text = ': set shared key challenge length (default: 128)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 17, column = 2, padx = 5, pady = 5)
        ...
        l16=Label(self.frame_content3, text = ': Caffe-Latte attack (long --caffe-latte)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 18, column = 2, padx = 5, pady = 5)
        
        self.C17 = Checkbutton(self.frame_content3, text = "-N", fg="deepskyblue", \
        ...
        l17=Label(self.frame_content3, text = ':  creates arp request against wep client (long cfrag)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 19, column = 2, padx = 5, pady = 5)
    
        
        self.C18 = Checkbutton(self.frame_content3, text = "-x", fg="deepskyblue", \
                 onvalue = "-x", offvalue = "", height=1, \
        ...
        l18=Label(self.frame_content3, text = ': number of packets per second (default: 100)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 21, column = 2, padx = 5, pady = 5)
        
        self.C19 = Checkbutton(self.frame_content3, text = "-y", fg="deepskyblue", \
                 onvalue = "-y", offvalue = "", height=1, \
        ...
        l19=Label(self.frame_content3, text = ': disables responses to broadcast probes',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 22, column = 2, padx = 5, pady = 5)
        
        Label(self.frame_content4, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
        
        self.C20 = Checkbutton(self.frame_content4, text = "--o", fg="deepskyblue", \
        ...
        l20=Label(self.frame_content4, text = ': set all WPA,WEP,open tags. can\'t be used with -z & -Z',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 23, column = 2, padx = 5, pady = 5)
        
        self.C21 = Checkbutton(self.frame_content4, text = "-z", fg="deepskyblue", \
        ...
        l21=Label(self.frame_content4, text = ':  sets WPA1 tags. 1=WEP40 2=TKIP 3=WRAP 4=CCMP 5=WEP104',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 24, column = 2, padx = 5, pady = 5)
        
        self.C22 = Checkbutton(self.frame_content4, text = "-Z", fg="deepskyblue", \
                 onvalue = "-Z", offvalue = "", height=1, \
        ...
        l22=Label(self.frame_content4, text = ':  same as -z, but for WPA2',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 25, column = 2, padx = 5, pady = 5)
        
        self.C23 = Checkbutton(self.frame_content4, text = "-V", fg="deepskyblue", \
                 onvalue = "-V", offvalue = "", height=1, \
        ...
        l23=Label(self.frame_content4, text = ':  fake EAPOL 1=MD5 2=SHA1 3=auto',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 26, column = 2, padx = 5, pady = 5)
        
        self.C24 = Checkbutton(self.frame_content4, text = "-F", fg="deepskyblue", \
                 onvalue = "-F", offvalue = "", height=1, \
        ...
        l24=Label(self.frame_content4, text = ':  write all sent and received frames into pcap file',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 27, column = 2, padx = 5, pady = 5)
        
        self.C25 = Checkbutton(self.frame_content4, text = "-P", fg="deepskyblue", \
        ...
        l25=Label(self.frame_content4, text = ':  respond to all probes, even when specifying ESSIDs',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 28, column = 2, padx = 5, pady = 5)
        
        
        self.C26 = Checkbutton(self.frame_content4, text = "-I", fg="deepskyblue", \
                 onvalue = "-I", offvalue = "", height=1, \
        ...
        l26=Label(self.frame_content4, text = ':  sets the beacon interval value in ms',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 29, column = 2, padx = 5, pady = 5)
        
        self.C27 = Checkbutton(self.frame_content4, text = "-C", fg="deepskyblue", \
                 onvalue = "-C", offvalue = "", height=1, \
        ...
        l27=Label(self.frame_content4, text = ':   enables beaconing of probed ESSID values (requires -P)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 30, column = 2, padx = 5, pady = 5)
        
        Label(self.frame_content6, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", fg="firebrick", padx=10, pady=10).grid(row = 0, column = 0)
        Label(self.frame_content6, text = 'Filter Options :',font=self.myfontnew, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 16, column = 1)
        
        self.C28 = Checkbutton(self.frame_content6, text = "--bssid", fg="deepskyblue", \
        ...
        l28=Label(self.frame_content6, text = ':  BSSID to filter/use (short -b)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 31, column = 2, padx = 5, pady = 5)
        
        self.C29 = Checkbutton(self.frame_content6, text = "--bssids", fg="deepskyblue", \
        ...
        l29=Label(self.frame_content6, text = ':  read a list of BSSIDs out of that file (short -B)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 32, column = 2, padx = 5, pady = 5)
        
        self.C30 = Checkbutton(self.frame_content6, text = "--client", fg="deepskyblue", \
        ...
        l30=Label(self.frame_content6, text = ':   MAC of client to accept (short -d)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 33, column = 2, padx = 5, pady = 5)
        
        self.C31 = Checkbutton(self.frame_content6, text = "--clients", fg="deepskyblue", \
        ...
        l31=Label(self.frame_content6, text = ':  read a list of MACs out of that file (short -D)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 34, column = 2, padx = 5, pady = 5)
        
        self.C32 = Checkbutton(self.frame_content6, text = "--essid", fg="deepskyblue", \
        ...
        l32=Label(self.frame_content6, text = ':  specify a single ESSID (short -e)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 35, column = 2, padx = 5, pady = 5)
        
        self.C33 = Checkbutton(self.frame_content6, text = "--essids", fg="deepskyblue", \
        ...
        l33=Label(self.frame_content6, text = ':  read a list of ESSIDs out of that file (short -E)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 36, column = 2, padx = 5, pady = 5)
        
        self.C34 = Checkbutton(self.frame_content6, text = "--help", fg="deepskyblue", \
        ...
        l34=Label(self.frame_content6, text = ':  Displays the usage screen (short -H)',font=self.myfont, bg="midnightblue", fg="deepskyblue", justify=LEFT).grid(row = 37, column = 2, padx = 5, pady = 5)
        #end

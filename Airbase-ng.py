...
class Feedback:
	...
	self.frame_content7 = Frame(nb, name='frame_content7', bg="lightsteelblue")
        ...
        #End
	#frame content 7
	Label(self.frame_content7, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", padx=10, pady=10).grid(row = 0, column = 0)
	...
	#End        
        ...
        Label(self.frame_content, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", padx=10, pady=10).grid(row = 0, column = 0)
        ...
        l1=Label(self.frame_content, text = ': set Access Point MAC address',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 2, column = 2, padx = 5, pady = 5)
        ...
        l2=Label(self.frame_content, text = ': capture packets from this interface',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 3, column = 2, padx = 5, pady = 5)
        ...
        l3=Label(self.frame_content, text = ': use this WEP key to encrypt/decrypt packets',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 4, column = 2, padx = 5, pady = 5)
        ...
        l4=Label(self.frame_content, text = ': source mac for MITM mode',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 5, column = 2, padx = 5, pady = 5)
        ...
        l5=Label(self.frame_content, text = ': disallow specified client MACs (default: allow)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 6, column = 2, padx = 5, pady = 5)
        ...
        l6=Label(self.frame_content, text = ': [don\'t] set WEP flag in beacons 0|1 (default: auto)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 7, column = 2, padx = 5, pady = 5)
        ...
        l7=Label(self.frame_content, text = ': quiet (do not print statistics)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 8, column = 2, padx = 5, pady = 5)
        ...
        l8=Label(self.frame_content2, text = ':  verbose (print more messages) (long --verbose)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 9, column = 2, padx = 5, pady = 5)
        ...
        l9=Label(self.frame_content2, text = ': M-I-T-M between [specified] clients and bssids',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 10, column = 2, padx = 5, pady = 5)
        
        Label(self.frame_content2, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", padx=10, pady=10).grid(row = 0, column = 0)
        ...
        l10=Label(self.frame_content2, text = ': Ad-Hoc Mode (allows other clients to peer) (long --ad-hoc)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 11, column = 2, padx = 5, pady = 5)
        ...
        l11=Label(self.frame_content2, text = ': external packet processing',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 12, column = 2, padx = 5, pady = 5)
        ...
        l12=Label(self.frame_content2, text = ': sets the channel the AP is running on',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 13, column = 2, padx = 5, pady = 5)
        ...
        l13=Label(self.frame_content2, text = ': hidden ESSID (long --hidden)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 14, column = 2, padx = 5, pady = 5)
        ...
        l14=Label(self.frame_content2, text = ': force shared key authentication',font=self.myfont, bg="midnightblue").grid(row = 15, column = 2, padx = 5, pady = 5)
        
        
        Label(self.frame_content3, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", padx=10, pady=10).grid(row = 0, column = 0)
        Label(self.frame_content3, text = 'Filter Options :',font=self.myfontnew, bg="midnightblue", justify=LEFT).grid(row = 16, column = 1)
        ...
        l15=Label(self.frame_content3, text = ': set shared key challenge length (default: 128)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 17, column = 2, padx = 5, pady = 5)
        ...
        l16=Label(self.frame_content3, text = ': Caffe-Latte attack (long --caffe-latte)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 18, column = 2, padx = 5, pady = 5)
        ...
        l17=Label(self.frame_content3, text = ':  creates arp request against wep client (long cfrag)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 19, column = 2, padx = 5, pady = 5)
        ...
        l18=Label(self.frame_content3, text = ': number of packets per second (default: 100)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 21, column = 2, padx = 5, pady = 5)
        ...
        l19=Label(self.frame_content3, text = ': disables responses to broadcast probes',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 22, column = 2, padx = 5, pady = 5)
        
        Label(self.frame_content4, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", padx=10, pady=10).grid(row = 0, column = 0)
        ...
        l20=Label(self.frame_content4, text = ': set all WPA,WEP,open tags. can\'t be used with -z & -Z',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 23, column = 2, padx = 5, pady = 5)
        ...
        l21=Label(self.frame_content4, text = ':  sets WPA1 tags. 1=WEP40 2=TKIP 3=WRAP 4=CCMP 5=WEP104',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 24, column = 2, padx = 5, pady = 5)
        ...
        l22=Label(self.frame_content4, text = ':  same as -z, but for WPA2',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 25, column = 2, padx = 5, pady = 5)
        ...
        l23=Label(self.frame_content4, text = ':  fake EAPOL 1=MD5 2=SHA1 3=auto',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 26, column = 2, padx = 5, pady = 5)
        ...
        l24=Label(self.frame_content4, text = ':  write all sent and received frames into pcap file',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 27, column = 2, padx = 5, pady = 5)
        ...
        l25=Label(self.frame_content4, text = ':  respond to all probes, even when specifying ESSIDs',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 28, column = 2, padx = 5, pady = 5)
        ...
        l26=Label(self.frame_content4, text = ':  sets the beacon interval value in ms',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 29, column = 2, padx = 5, pady = 5)
        ...
        l27=Label(self.frame_content4, text = ':   enables beaconing of probed ESSID values (requires -P)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 30, column = 2, padx = 5, pady = 5)
        
        Label(self.frame_content6, text = 'Airbase-ng',font=self.headerfont, bg="midnightblue", padx=10, pady=10).grid(row = 0, column = 0)
        Label(self.frame_content6, text = 'Filter Options :',font=self.myfontnew, bg="midnightblue", justify=LEFT).grid(row = 16, column = 1)
        ...
        l28=Label(self.frame_content6, text = ':  BSSID to filter/use (short -b)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 31, column = 2, padx = 5, pady = 5)
        ...
        l29=Label(self.frame_content6, text = ':  read a list of BSSIDs out of that file (short -B)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 32, column = 2, padx = 5, pady = 5)
        ...
        l30=Label(self.frame_content6, text = ':   MAC of client to accept (short -d)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 33, column = 2, padx = 5, pady = 5)
        ...
        l31=Label(self.frame_content6, text = ':  read a list of MACs out of that file (short -D)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 34, column = 2, padx = 5, pady = 5)
        ...
        l32=Label(self.frame_content6, text = ':  specify a single ESSID (short -e)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 35, column = 2, padx = 5, pady = 5)
        ...
        l33=Label(self.frame_content6, text = ':  read a list of ESSIDs out of that file (short -E)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 36, column = 2, padx = 5, pady = 5)
        ...
        l34=Label(self.frame_content6, text = ':  Displays the usage screen (short -H)',font=self.myfont, bg="midnightblue", justify=LEFT).grid(row = 37, column = 2, padx = 5, pady = 5)
        #end
